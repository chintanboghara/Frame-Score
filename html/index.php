...
<head>
  ...
  <title>Frame Score - Ratings, Reviews, and Where to Watch the Best Movies & TV Shows</title>
    ...
    <div class="container">
      ...
      <nav class="navbar" data-navbar>
        ...
        <ul class="navbar-list">
          ...
          <li>
            <a href="./tvshows.html" class="navbar-link">TV Shows</a>
          </li>
      ...
      <section class="hero">
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <p class="hero-subtitle">Frame Score</p>

            <h1 class="h1 hero-title">
              Unlimited <strong>Movies</strong> <br /> TV Shows, & More...
            </h1>
